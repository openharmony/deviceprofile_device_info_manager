...
#ifndef OHOS_DP_PROFILE_LISTENER_STUB_H
#define OHOS_DP_PROFILE_LISTENER_STUB_H
...
public:
    ...
    int32_t OnServiceProfileAddInner(MessageParcel& data, MessageParcel& reply);
    int32_t OnServiceProfileDeleteInner(MessageParcel& data, MessageParcel& reply);
    int32_t OnServiceProfileUpdateInner(MessageParcel& data, MessageParcel& reply);
...
#endif // OHOS_DP_PROFILE_LISTENER_STUB_H
