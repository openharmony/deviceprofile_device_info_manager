...
//delete end
constexpr int32_t DP_SERVICE_INFO_MANAGER_INIT_FAIL = 98566312;
constexpr int32_t DP_PUT_SERVICE_INFO_FAIL = 98566313;
constexpr int32_t DP_DELETE_SERVICE_INFO_FAIL = 98566314;
constexpr int32_t DP_UPDATE_SERVICE_INFO_PROFILE_FAIL = 98566315;

// asset
constexpr int32_t DP_ASSET_DUPLICATED = 98566316;
constexpr int32_t DP_PUT_ASSET_ERROR = 98566317;
constexpr int32_t DP_UPDATE_ASSET_ERROR = 98566318;
constexpr int32_t DP_GET_ASSET_ERROE = 98566319;
...
constexpr int32_t DP_LOCAL_SERVICE_INFO_EXISTS = 98566325;
constexpr int32_t DP_PUT_LOCAL_SERVICE_INFO_FAIL = 98566326;
constexpr int32_t DP_DELETE_LOCAL_SERVICE_INFO_FAIL = 98566327;
constexpr int32_t DP_UPDATE_LOCAL_SERVICE_INFO_FAIL = 98566328;
constexpr int32_t DP_LOCAL_SERVICE_INFO_MANAGER_INIT_FAIL = 98566329;
constexpr int32_t DP_SERVICE_ON_IDLE = 98566330;
constexpr int32_t DP_SERVICE_STOPPED = 98566331;
constexpr int32_t DP_BUSINESS_EVENT_MANAGER_INIT_FAIL = 98566332;
constexpr int32_t DP_BUSINESS_EVENT_MANAGER_UNINIT_FAIL = 98566333;
constexpr int32_t DP_PUT_BUSINESS_EVENT_FAIL = 98566334;
constexpr int32_t DP_GET_BUSINESS_EVENT_FAIL = 98566335;
constexpr int32_t DP_NOTIFY_BUSINESS_EVENT_FAIL = 98566336;
constexpr int32_t DP_INVALID_SQL_RESULT = 98566337;
constexpr int32_t DP_DEVICE_UNSUPPORTED_SWITCH = 98566338;
