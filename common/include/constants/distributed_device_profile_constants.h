...
extern const std::string SERVICEID;
...
constexpr uint32_t MAX_PROFILE_SIZE = 10000;
constexpr int32_t MAX_DEVICE_SIZE = 1000;
constexpr uint32_t MAX_SERVICE_SIZE = 5000;
constexpr int32_t MAX_CHAR_SIZE = 1000;
constexpr int32_t MAX_DB_SIZE = 5000;
...
extern const std::string SERVICE_ID_KEY;
extern const std::string SERVICE_ID_VALUE;
extern const std::string SERVICE_TYPE_KEY;
extern const std::string SERVICE_TYPE_VALUE;
extern const std::string SERVICE_NAME_KEY;
extern const std::string SERVICE_NAME_VALUE;
extern const std::string SERVICE_DISPLAY_NAME_KEY;
extern const std::string SERVICE_DISPLAY_NAME_VALUE;
extern const std::string REG_SERVICE_ID_KEY;
extern const std::string REG_SERVICE_ID_VALUE;
extern const std::string SER_PUB_STATE_KEY;
extern const std::string SER_PUB_STATE_VALUE;
extern const std::string DEVICE_ID_KEY;
extern const std::string DEVICE_ID_VALUE;
extern const std::string SER_USER_ID_KEY;
extern const std::string SER_USER_ID_VALUE;
extern const std::string SER_TOKEN_ID_KEY;
extern const std::string SER_TOKEN_ID_VALUE;
...
constexpr int32_t DP_ERR_DEAD_OBJECT = 32;
constexpr int32_t DP_BR_DEAD_REPLY = 29189;
