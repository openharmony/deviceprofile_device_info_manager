...
extern const std::string EMUI_VERSION;
...
extern const std::string INNER_MODEL;
...
extern const std::string HW_EN_UP;
extern const std::string HW_EN_LW;
extern const std::string HW_ZH;
