...
#ifndef OHOS_DP_CONTENT_SENSOR_MANAGER_UTILS_REFACTOR_H
#define OHOS_DP_CONTENT_SENSOR_MANAGER_UTILS_REFACTOR_H
...
#endif // OHOS_DP_CONTENT_SENSOR_MANAGER_UTILS_REFACTOR_H