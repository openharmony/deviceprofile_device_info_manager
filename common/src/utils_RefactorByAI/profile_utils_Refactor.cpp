    ...
    std::shared_ptr<ResultSet> trustResultSet, TrustDeviceProfile& trustDeviceProfile)
{
    ...
    SecureClearString(deviceId);
    SecureClearString(deviceIdHash);
    return DP_SUCCESS;
}
    ...
    Accesser& accesser)
{
    ...
    SecureClearString(accesserDeviceId);
    SecureClearString(accesserAccountId);
    SecureClearString(accesserHapSignature);
    SecureClearString(accesserCredentialIdStr);
    return DP_SUCCESS;
}
    ...
    Accessee& accessee)
{
    ...
    SecureClearString(accesseeDeviceId);
    SecureClearString(accesseeAccountId);
    SecureClearString(accesseeHapSignature);
    SecureClearString(accesseeCredentialIdStr);
    return DP_SUCCESS;
}
    ...
    std::shared_ptr<ResultSet> accessControlResultSet, AccessControlProfile& accessControlProfile)
{
    ...
    SecureClearString(trustDeviceId);
    SecureClearString(sessionKey);
    SecureClearString(deviceIdHash);
    return DP_SUCCESS;
}
...
void ProfileUtils::SecureClearString(std::string& str)
{
    if (!str.empty()) {
        volatile char* ptr = &str[0];
        for (size_t i = 0; i < str.size(); ++i) {
