...
std::string Accessee::GetAccesseeServiceName() const
{
...
std::string Accessee::dump() const
{
    ...
    cJSON_AddStringToObject(json, ACCESSEE_BUNDLE_NAME.c_str(),
        ProfileUtils::GetAnonyString(accesseeBundleName_).c_str());
