...
enum {
    ...
    ERR_DP_LOAD_SERVICE_ERR = 98566160,
    ERR_DP_GET_DATA_FAILED = 98566161,
    ERR_DP_DELETE_DATA_FAILED = 98566162,
    ERR_DP_ADD_DATA_FAILED = 98566163,
    ERR_DP_SYNC_DATA_FAILED = 98566164,
};
} // namespace DeviceProfile
} // namespace OHOS
