...
#ifndef OHOS_DP_SERVICE_INFO_RDB_ADAPTER_H
#define OHOS_DP_SERVICE_INFO_RDB_ADAPTER_H
...
class ServiceInfoRdbAdapter : public IRdbAdapter {
    DECLARE_SINGLE_INSTANCE(ServiceInfoRdbAdapter);
public:
...
private:
    ...
    std::mutex ServiceInfoRdbAdapterMtx_;
};

class ServiceInfoOpenCallback : public NativeRdb::RdbOpenCallback {
public:
...
#endif // OHOS_DP_SERVICE_INFO_RDB_ADAPTER_H
