...
#ifndef OHOS_DP_LOCAL_SERVICE_INFO_RDB_ADAPTER_H
#define OHOS_DP_LOCAL_SERVICE_INFO_RDB_ADAPTER_H
...
class LocalServiceInfoRdbAdapter : public IRdbAdapter {
    DECLARE_SINGLE_INSTANCE(LocalServiceInfoRdbAdapter);
public:
...
private:
    ...
    std::mutex LocalServiceInfoRdbAdapterMtx_;
};

class LocalServiceInfoOpenCallback : public NativeRdb::RdbOpenCallback {
public:
...
#endif // OHOS_DP_LOCAL_SERVICE_INFO_RDB_ADAPTER_H
