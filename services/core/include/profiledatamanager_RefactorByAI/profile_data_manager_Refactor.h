...
#ifndef OHOS_DP_PROFILE_DATA_MANAGER_REFACTOR_H
#define OHOS_DP_PROFILE_DATA_MANAGER_REFACTOR_H
...
private:
    // [原则3] 检测路径穿越模式（包含SEPARATOR和SLASHES的字符串），返回true表示检测到非法模式
...
#endif // OHOS_DP_PROFILE_DATA_MANAGER_REFACTOR_H
