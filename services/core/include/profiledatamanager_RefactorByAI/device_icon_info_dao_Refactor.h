...
#ifndef OHOS_DP_DEVICE_ICON_INFO_DAO_REFACTOR_H
#define OHOS_DP_DEVICE_ICON_INFO_DAO_REFACTOR_H
...
private:
    // [原则3] 入库/更新前的数据合法性校验，防止主键为空或字段超长导致数据异常
    bool IsValidDeviceIconInfo(const DeviceIconInfo& deviceIconInfo) const;
    std::mutex rdbMutex_;
};
} // DistributedDeviceProfile
} // OHOS
#endif // OHOS_DP_DEVICE_ICON_INFO_DAO_REFACTOR_H
