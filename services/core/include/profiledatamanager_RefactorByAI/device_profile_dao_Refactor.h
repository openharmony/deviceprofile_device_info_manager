...
#ifndef OHOS_DP_DEVICE_PROFILE_DAO_REFACTOR_H
#define OHOS_DP_DEVICE_PROFILE_DAO_REFACTOR_H
...
private:
    // [原则3] 入库/更新前的数据合法性校验
    bool IsValidDeviceProfile(const DeviceProfile& deviceProfile) const;
    std::mutex rdbMutex_;
};
}
}
#endif // OHOS_DP_DEVICE_PROFILE_DAO_REFACTOR_H
