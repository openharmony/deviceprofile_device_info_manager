...
#ifndef OHOS_DP_PRODUCT_INFO_DAO_REFACTOR_H
#define OHOS_DP_PRODUCT_INFO_DAO_REFACTOR_H
...
private:
    ...
    bool IsValidProductInfo(const ProductInfo& productInfo) const;
    std::mutex rdbMutex_;
};
} // DistributedDeviceProfile
} // OHOS
#endif // OHOS_DP_PRODUCT_INFO_DAO_REFACTOR_H
