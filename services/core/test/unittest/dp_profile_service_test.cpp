...
HWTEST_F(DpProfileServiceTest, GetAccessControlProfile_001, TestSize.Level1)
{
    ...
    int32_t ret = DistributedDeviceProfileServiceNew::GetInstance().GetAccessControlProfile(
        queryParams, accessControlProfiles);
    EXPECT_EQ(DP_PERMISSION_DENIED, ret);
}
...
HWTEST_F(DpProfileServiceTest, GetServiceProfile_001, TestSize.Level1)
{
    ...
    int32_t ret = DistributedDeviceProfileServiceNew::GetInstance().GetServiceProfile(
        devid, serName, serviceProfile);
    EXPECT_EQ(DP_PERMISSION_DENIED, ret);
}
...
HWTEST_F(DpProfileServiceTest, GetCharacteristicProfile_001, TestSize.Level1)
{
    ...
    std::string charKey = "";
    CharacteristicProfile charProfile;
    int32_t ret = DistributedDeviceProfileServiceNew::GetInstance().GetCharacteristicProfile(
        devid, serName, charKey, charProfile);
    EXPECT_EQ(DP_PERMISSION_DENIED, ret);
}
...
HWTEST_F(DpProfileServiceTest, DeleteCharacteristicProfile_001, TestSize.Level1)
{
    ...
    std::string serName = "";
    std::string charKey = "";
    int32_t ret = DistributedDeviceProfileServiceNew::GetInstance().DeleteCharacteristicProfile(
