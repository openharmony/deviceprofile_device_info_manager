...
HWTEST_F(DpProfileServiceTest, Init_001, TestSize
.Level1) {
...
HWTEST_F(DpProfileServiceTest, UnInit_001, TestSize
.Level1) {
...
HWTEST_F(DpProfileServiceTest, CreateUnloadHandler_001, TestSize
.Level1)
{
DistributedDeviceProfileServiceNew::GetInstance()
.
...
HWTEST_F(DpProfileServiceTest, PutAccessControlProfile_001, TestSize
.Level1)
{
...
HWTEST_F(DpProfileServiceTest, UpdateAccessControlProfile_001, TestSize
.Level1)
{
AccessControlProfile accessControlProfile;
...
HWTEST_F(DpProfileServiceTest, GetTrustDeviceProfile_001, TestSize
.Level1)
{
std::string devid;
...
HWTEST_F(DpProfileServiceTest, GetAllTrustDeviceProfile_001, TestSize
.Level1)
{
...
HWTEST_F(DpProfileServiceTest, GetAccessControlProfile_001, TestSize
.Level1)
{
...
HWTEST_F(DpProfileServiceTest, GetAllAccessControlProfile_001, TestSize
.Level1)
{
std::vector<AccessControlProfile> accessControlProfiles;
...
HWTEST_F(DpProfileServiceTest, DeleteAccessControlProfile_001, TestSize
.Level1)
{
...
HWTEST_F(DpProfileServiceTest, PutServiceProfile_001, TestSize
.Level1)
{
std::string devid = "";
...
HWTEST_F(DpProfileServiceTest, PutServiceProfileBatch_001, TestSize
.Level1)
{
...
HWTEST_F(DpProfileServiceTest, PutCharacteristicProfile_001, TestSize
.Level1)
{
...
HWTEST_F(DpProfileServiceTest, PutCharacteristicProfileBatch_001, TestSize
.Level1)
{
std::string devid = "";
std::string serName = "serName_test";
...
HWTEST_F(DpProfileServiceTest, GetServiceProfile_001, TestSize
.Level1)
{
std::string devid = "";
std::string serName = "";
...
HWTEST_F(DpProfileServiceTest, GetCharacteristicProfile_001, TestSize
.Level1)
{
std::string devid = "";
std::string serName = "";
...
HWTEST_F(DpProfileServiceTest, DeleteServiceProfile_001, TestSize
.Level1)
{
std::string devid = "";
std::string serName = "";
...
HWTEST_F(DpProfileServiceTest, DeleteCharacteristicProfile_001, TestSize
.Level1)
{
std::string devid = "";
std::string serName = "";
...
HWTEST_F(DpProfileServiceTest, SubscribeDeviceProfile_001, TestSize
.Level1)
{
...
HWTEST_F(DpProfileServiceTest, UnSubscribeDeviceProfile_001, TestSize
.Level1)
{
SubscribeInfo subscriberInfo;
...
HWTEST_F(DpProfileServiceTest, SyncDeviceProfile_001, TestSize
.Level1)
{
...
HWTEST_F(DpProfileServiceTest, Dump_001, TestSize
.Level1)
{
int32_t fd = -1;
