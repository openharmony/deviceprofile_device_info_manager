...
class MockDistributedDeviceProfileStubNew : public DistributedDeviceProfileStubNew {
    ...
    int32_t GetSessionKey(int32_t sessionKeyId, std::vector<uint8_t>& sessionKey) override;
...
int32_t MockDistributedDeviceProfileStubNew::GetSessionKey(int32_t sessionKeyId, std::vector<uint8_t>& sessionKey)
{
    (void)sessionKey;
    (void)sessionKeyId;
    return 0;
