...
#include "static_profile_manager_Refactor.h"
...
{
    HILOGD("call!");
    // [原则3] 入库前校验关键字段合法性，与GetCharacteristicProfile保持一致
...
// [原则12] cJSON资源清理：所有错误路径均调用cJSON_Delete(charValueJson)，无泄漏
...
void StaticProfileManager::E2ESyncStaticProfile(const TrustedDeviceInfo& deviceInfo)
{
    ...
    // [原则12] StaticProfileManager为单例（DECLARE_SINGLE_INSTANCE），生命周期与进程一致，lambda捕获this安全
