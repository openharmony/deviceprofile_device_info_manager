...
#ifndef OHOS_DP_SESSION_KEY_MANAGER_REFACTOR_H
#define OHOS_DP_SESSION_KEY_MANAGER_REFACTOR_H
...
private:
    ...
    bool GenerateSecureRandomNumber(int32_t& randomNumber);
};
} // namespace DistributedDeviceProfile
} // namespace OHOS
#endif // OHOS_DP_SESSION_KEY_MANAGER_REFACTOR_H