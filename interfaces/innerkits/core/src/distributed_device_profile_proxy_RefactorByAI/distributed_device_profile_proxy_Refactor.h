...
#ifndef OHOS_DP_DISTRIBUTED_DEVICE_PROFILE_PROXY_REFACTOR_H
#define OHOS_DP_DISTRIBUTED_DEVICE_PROFILE_PROXY_REFACTOR_H
...
#endif // OHOS_DP_DISTRIBUTED_DEVICE_PROFILE_PROXY_REFACTOR_H