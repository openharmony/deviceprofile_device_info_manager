...
int32_t DistributedDeviceProfileProxy::PutAccessControlProfile(const AccessControlProfile& aclProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_ACL_PROFILE), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::UpdateAccessControlProfile(const AccessControlProfile& aclProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::UPDATE_ACL_PROFILE), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutProductInfoBatch(const std::vector<ProductInfo>& productInfos)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_PRODUCT_INFO_BATCH), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutDeviceIconInfoBatch(const std::vector<DeviceIconInfo>& deviceIconInfos)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_DEVICE_ICON_INFO_BATCH), data, reply);
    return DP_SUCCESS;
}
    ...
    std::vector<DeviceIconInfo>& deviceIconInfos)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_DEVICE_ICON_INFOS), data, reply);
    ...
    TrustDeviceProfile& trustDeviceProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_TRUST_DEVICE_PROFILE), data, reply);
...
int32_t DistributedDeviceProfileProxy::GetAllTrustDeviceProfile(std::vector<TrustDeviceProfile>& trustDeviceProfiles)
{
    ...
    WRITE_INTERFACE_TOKEN(data);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_ALL_TRUST_DEVICE_PROFILE), data, reply);
    ...
    std::vector<AccessControlProfile>& accessControlProfiles)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_ACL_PROFILE), data, reply);
    ...
    std::vector<AccessControlProfile>& accessControlProfiles)
{
    ...
    WRITE_INTERFACE_TOKEN(data);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_ALL_ACL_PROFILE), data, reply);
    if (!IpcUtils::UnMarshalling(reply, accessControlProfiles)) {
        HILOGE("dp ipc read parcel fail");
        return DP_READ_PARCEL_FAIL;
    }
...
int32_t DistributedDeviceProfileProxy::GetAllAclIncludeLnnAcl(std::vector<AccessControlProfile>& accessControlProfiles)
{
    ...
    WRITE_INTERFACE_TOKEN(data);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_ALL_ACL_INCLUDE_LNN_ACL), data, reply);
    if (!IpcUtils::UnMarshalling(reply, accessControlProfiles)) {
        HILOGE("dp ipc read parcel fail");
        return DP_READ_PARCEL_FAIL;
    }
...
int32_t DistributedDeviceProfileProxy::DeleteAccessControlProfile(int32_t accessControlId)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::DELETE_ACL_PROFILE), data, reply);
    return DP_SUCCESS;
}
    ...
    uint32_t userId, const std::vector<uint8_t>& sessionKey, int32_t& sessionKeyId)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_SESSION_KEY), data, reply);
    ...
    uint32_t userId, int32_t sessionKeyId, const std::vector<uint8_t>& sessionKey)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::UPDATE_SESSION_KEY), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::DeleteSessionKey(uint32_t userId, int32_t sessionKeyId)
{
    ...
    WRITE_HELPER(data, Int32, sessionKeyId);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::DELETE_SESSION_KEY), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutDeviceProfileBatch(std::vector<DeviceProfile>& deviceProfiles)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_DEVICE_PROFILE_BATCH), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutServiceProfile(const ServiceProfile& serviceProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_SERVICE_PROFILE), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutServiceProfileBatch(const std::vector<ServiceProfile>& serviceProfiles)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_SERVICE_PROFILE_BATCH), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutCharacteristicProfile(const CharacteristicProfile& charProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_CHAR_PROFILE), data, reply);
    return DP_SUCCESS;
}
    ...
    const std::vector<CharacteristicProfile>& charProfiles)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_CHAR_PROFILE_BATCH), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::GetDeviceProfile(const std::string& deviceId, DeviceProfile& deviceProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_DEVICE_PROFILE_NEW), data, reply);
    ...
    std::vector<DeviceProfile>& deviceProfiles)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_DEVICE_PROFILES), data, reply);
...
int32_t DistributedDeviceProfileProxy::DeleteDeviceProfileBatch(std::vector<DeviceProfile>& deviceProfiles)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::DELETE_DEVICE_PROFILE_BATCH), data, reply);
    return DP_SUCCESS;
}
    ...
    ServiceProfile& serviceProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_SERVICE_PROFILE), data, reply);
...
int32_t DistributedDeviceProfileProxy::UpdateServiceInfoProfile(const ServiceInfoProfile& serviceInfoProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::UPDATE_SERVICE_INFO_PROFILE), data, reply);
    return DP_SUCCESS;
}
    ...
    ServiceInfoProfile& serviceInfoProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_SERVICE_INFO_PROFILE_BY_UNIQUE_KEY),
        data, reply);
    ...
    std::vector<ServiceInfoProfile>& serviceInfoProfiles)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_SERVICE_INFO_PROFILE_LIST_BY_TOKEN_ID),
        data, reply);
    ...
    std::vector<ServiceInfoProfile>& serviceInfoProfiles)
{
    ...
    WRITE_INTERFACE_TOKEN(data);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_ALL_SERVICE_INFO_PROFILE_LIST),
        data, reply);
    if (!IpcUtils::UnMarshalling(reply, serviceInfoProfiles)) {
        HILOGE("dp ipc read parcel fail");
        return DP_READ_PARCEL_FAIL;
    ...
    std::vector<ServiceInfoProfile>& serviceInfoProfiles)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_SERVICE_INFO_PROFILE_LIST_BY_BUNDLE_NAME),
        data, reply);
    if (!IpcUtils::UnMarshalling(reply, serviceInfoProfiles)) {
        HILOGE("dp ipc read parcel fail");
        return DP_READ_PARCEL_FAIL;
    ...
    const std::string& serviceName, const std::string& characteristicId, CharacteristicProfile& charProfile)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_CHAR_PROFILE), data, reply);
    ...
    const std::string& serviceName, bool isMultiUser, int32_t userId)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::DEL_SERVICE_PROFILE), data, reply);
    return DP_SUCCESS;
}
    ...
    const std::string& serviceName, const std::string& characteristicId, bool isMultiUser, int32_t userId)
{
    ...
    WRITE_HELPER(data, Int32, userId);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::DEL_CHAR_PROFILE), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::SubscribeDeviceProfile(const SubscribeInfo& subscribeInfo)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::SUBSCRIBE_DEVICE_PROFILE), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::UnSubscribeDeviceProfile(const SubscribeInfo& subscribeInfo)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::UNSUBSCRIBE_DEVICE_PROFILE), data, reply);
    return DP_SUCCESS;
}
    ...
    const sptr<IRemoteObject> syncCompletedCallback)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::SYNC_DEVICE_PROFILE_NEW), data, reply);
    return DP_SUCCESS;
}
    ...
    const sptr<IRemoteObject> syncCompletedCallback)
{
    ...
    WRITE_HELPER(data, RemoteObject, syncCompletedCallback);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::SYNC_STATIC_PROFILE), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::SendSubscribeInfos(std::map<std::string, SubscribeInfo> listenerMap)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::SEND_SUBSCRIBE_INFOS), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::SubscribeDeviceProfileInited(int32_t saId, sptr<IRemoteObject> dpInitedCallback)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::SUBSCRIBE_DEVICE_PROFILE_INITED), data, reply);
    return DP_SUCCESS;
}
...
int32_t OHOS::DistributedDeviceProfile::DistributedDeviceProfileProxy::UnSubscribeDeviceProfileInited(int32_t saId)
{
    ...
    WRITE_HELPER(data, Int32, saId);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::UNSUBSCRIBE_DEVICE_PROFILE_INITED), data, reply);
    return DP_SUCCESS;
}
    ...
    const std::string& bundleName, int32_t pinExchangeType, sptr<IRemoteObject> pinCodeCallback)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::SUBSCRIBE_PINCODE_INVALID), data, reply);
    return DP_SUCCESS;
}
    ...
    const std::string& bundleName, int32_t pinExchangeType)
{
    ...
    WRITE_HELPER(data, Int32, pinExchangeType);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::UNSUBSCRIBE_PINCODE_INVALID), data, reply);
    return DP_SUCCESS;
}
    ...
    const std::vector<TrustedDeviceInfo> deviceInfos)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_ALL_TRUSTED_DEVICES), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutLocalServiceInfo(const LocalServiceInfo& localServiceInfo)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_LOCAL_SERVICE_INFO), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::UpdateLocalServiceInfo(const LocalServiceInfo& localServiceInfo)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::UPDATE_LOCAL_SERVICE_INFO), data, reply);
    return DP_SUCCESS;
}
    ...
    int32_t pinExchangeType, LocalServiceInfo& localServiceInfo)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote,
        static_cast<uint32_t>(DpIpcInterfaceCode::GET_LOCAL_SERVICE_INFO_BY_BINDLE_AND_PINTYPE), data, reply);
...
int32_t DistributedDeviceProfileProxy::DeleteLocalServiceInfo(const std::string& bundleName, int32_t pinExchangeType)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote,
        static_cast<uint32_t>(DpIpcInterfaceCode::DELETE_LOCAL_SERVICE_INFO), data, reply);
    return DP_SUCCESS;
}
    ...
    const std::string& businessKey, sptr<IRemoteObject> businessCallback)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::REGISTER_BUSINESS_CALLBACK), data, reply);
    return DP_SUCCESS;
}
    ...
    const std::string& businessKey)
{
    ...
    WRITE_HELPER(data, String, businessKey);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::UNREGISTER_BUSINESS_CALLBACK), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutBusinessEvent(const BusinessEvent& event)
{
    ...
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_BUSINESS_EVENT), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::PutServiceInfo(const ServiceInfo& serviceInfo)
{
    ...
    MessageParcel data;
    WRITE_INTERFACE_TOKEN(data);
    if (!serviceInfo.Marshalling(data)) {
        HILOGE("dp ipc serviceInfo write parcel fail");
        return DP_WRITE_PARCEL_FAIL;
    }
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::PUT_SERVICE_INFO), data, reply);
    return DP_SUCCESS;
}
...
int32_t DistributedDeviceProfileProxy::DeleteServiceInfo(const UserInfo& userInfo)
{
    ...
    MessageParcel data;
    WRITE_INTERFACE_TOKEN(data);
    if (!userInfo.Marshalling(data)) {
        HILOGE("dp ipc write parcel fail");
        return DP_WRITE_PARCEL_FAIL;
    }

    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::DELETE_SERVICE_INFO), data, reply);
    return DP_SUCCESS;
}

int32_t DistributedDeviceProfileProxy::GetAllServiceInfoList(
    std::vector<ServiceInfo>& serviceInfos)
{
    ...
    WRITE_INTERFACE_TOKEN(data);
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_ALL_SERVICE_INFO_LIST),
        data, reply);

    if (!IpcUtils::UnMarshalling(reply, serviceInfos)) {
        HILOGE("dp ipc read parcel fail");
        return DP_READ_PARCEL_FAIL;
    }
    return DP_SUCCESS;
...
int32_t DistributedDeviceProfileProxy::GetServiceInfosByUserInfo(const UserInfo& userInfo,
    std::vector<ServiceInfo>& serviceInfos)
{
    sptr<IRemoteObject> remote = nullptr;
    GET_REMOTE_OBJECT(remote);
    ...
    WRITE_INTERFACE_TOKEN(data);
    if (!userInfo.Marshalling(data)) {
        HILOGE("dp ipc userInfo write parcel fail");
        return DP_WRITE_PARCEL_FAIL;
    }
    MessageParcel reply;
    SEND_REQUEST(remote, static_cast<uint32_t>(DpIpcInterfaceCode::GET_SERVICE_INFO_BY_USER_INFO),
        data, reply);
    if (!IpcUtils::UnMarshalling(reply, serviceInfos)) {
        HILOGE("dp ipc serviceInfos read parcel fail");
        return DP_READ_PARCEL_FAIL;
    }
    return DP_SUCCESS;
}

int32_t DistributedDeviceProfileProxy::SubscribeAllServiceInfo(int32_t saId, sptr<IRemoteObject> listener)
{
    sptr<IRemoteObject> remote = nullptr;
    GET_REMOTE_OBJECT(remote);
    MessageParcel data;
    WRITE_INTERFACE_TOKEN(data);
    WRITE_HELPER(data, Int32, saId);
    WRITE_HELPER(data, RemoteObject, listener);
    MessageParcel reply;
